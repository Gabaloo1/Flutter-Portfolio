      ...
      child: Column(
        children: [
          ...
          whatIdoCardMobile(
              ...
              kCard4Descrption,
              kCard4URL),
          whatIdoCardMobile(height, width, Colors.tealAccent.withOpacity(0.4),
              'lib/images/ai.png', kCard2title, kCard2Descrption, kCard2URL),
          whatIdoCardMobile(height, width, Colors.blueAccent.withOpacity(0.4),
              'lib/images/ta.png', kCard3title, kCard3Descrption, kCard3URL),
          whatIdoCardMobile(
              height,
              width,
              Colors.redAccent.withOpacity(0.4),
              ...
              kCard5Descrption,
              kCard5URL),
          whatIdoCardMobile(height, width, Colors.greenAccent.withOpacity(0.4),
              'lib/images/core.png', kCard1title, kCard1Descrption, kCard1URL),
          SizedBox(
            height: 30,
          ),
          whoIAmWidget(30),
